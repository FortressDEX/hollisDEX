...
var IPangolinPair = _interopDefault(require('@pangolindex/exchange-contracts/artifacts/contracts/pangolin-core/PangolinPair.sol/PangolinPair.json'));
...
var FACTORY_ADDRESS = (_FACTORY_ADDRESS = {}, _FACTORY_ADDRESS[exports.ChainId.FUJI] = '0xE4A575550C2b460d2307b82dCd7aFe84AD1484dd', _FACTORY_ADDRESS[exports.ChainId.AVALANCHE] = '0xefa94DE7a4656D787667C749f7E1223D71E9FD88', _FACTORY_ADDRESS[exports.ChainId.WAGMI] = '0xf7D180bE35be07fA5B2EC584aB7bF2B701e6EB45', _FACTORY_ADDRESS);
...
var Fetcher = /*#__PURE__*/function () {
  ...
  Fetcher.fetchTokenData = function fetchTokenData(chainId, address, provider, symbol, name) {
    try {
      ...
      if (chainId === undefined) chainId = exports.ChainId.AVALANCHE;
...
Currency.CURRENCY = (_Currency$CURRENCY = {}, _Currency$CURRENCY[exports.ChainId.FUJI] = /*#__PURE__*/new Currency(18, 'AVAX', 'Avalanche'), _Currency$CURRENCY[exports.ChainId.AVALANCHE] = /*#__PURE__*/new Currency(18, 'AVAX', 'Avalanche'), _Currency$CURRENCY[exports.ChainId.WAGMI] = /*#__PURE__*/new Currency(18, 'WGM', 'Wagmi'), _Currency$CURRENCY); //$ const CAVAX = Currency.CAVAX
...
var Token = /*#__PURE__*/function (_Currency) {
  ...
  function Token(chainId, address, decimals, symbol, name) {
    ...
    _this.chainId = exports.ChainId.AVALANCHE;
...
var WAVAX = (_WAVAX = {}, _WAVAX[exports.ChainId.FUJI] = /*#__PURE__*/new Token(exports.ChainId.FUJI, '0xd00ae08403B9bbb9124bB305C09058E32C39A48c', 18, 'WAVAX', 'Wrapped AVAX'), _WAVAX[exports.ChainId.AVALANCHE] = /*#__PURE__*/new Token(exports.ChainId.AVALANCHE, '0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7', 18, 'WAVAX', 'Wrapped AVAX'), _WAVAX[exports.ChainId.WAGMI] = /*#__PURE__*/new Token(exports.ChainId.WAGMI, '0x3Ee7094DADda15810F191DD6AcF7E4FFa37571e4', 18, 'wWAGMI', 'Wrapped WAGMI'), _WAVAX);
...
var Route = /*#__PURE__*/function () {
  function Route(pairs, input, output) {
    ...
    !(input instanceof Token && pairs[0].involvesToken(input) || input === CAVAX[pairs[0].chainId] && pairs[0].involvesToken(WAVAX[pairs[0].chainId])) ?  invariant(false, 'INPUT')  : void 0;
    !(typeof output === 'undefined' || output instanceof Token && pairs[pairs.length - 1].involvesToken(output) || output === CAVAX[pairs[0].chainId] && pairs[pairs.length - 1].involvesToken(WAVAX[pairs[0].chainId])) ?  invariant(false, 'OUTPUT')  : void 0;
...
var Trade = /*#__PURE__*/function () {
  function Trade(route, amount, tradeType, chainId) {
    ...
    this.inputAmount = tradeType === exports.TradeType.EXACT_INPUT ? amount : route.input === CAVAX[chainId] ? CurrencyAmount.ether(amounts[0].raw, chainId) : amounts[0];
    this.outputAmount = tradeType === exports.TradeType.EXACT_OUTPUT ? amount : route.output === CAVAX[chainId] ? CurrencyAmount.ether(amounts[amounts.length - 1].raw, chainId) : amounts[amounts.length - 1];
...
exports.ARBITRUM_RINKEBY = ARBITRUM_RINKEBY;
exports.ASTAR_MAINNET = ASTAR_MAINNET;
exports.AURORA_MAINNET = AURORA_MAINNET;
exports.AURORA_TESTNET = AURORA_TESTNET;
exports.AVALANCHE_FUJI = AVALANCHE_FUJI;
exports.AVALANCHE_MAINNET = AVALANCHE_MAINNET;
exports.BITTORRENT_MAINNET = BITTORRENT_MAINNET;
exports.BITTORRENT_TESTNET = BITTORRENT_TESTNET;
exports.BOBA_MAINNET = BOBA_MAINNET;
exports.BSC_MAINNET = BSC_MAINNET;
exports.BSC_TESTNET = BSC_TESTNET;
exports.CAVAX = CAVAX;
exports.CELO_ALFAJORES_TESTNET = CELO_ALFAJORES_TESTNET;
exports.CELO_BAKLAVA_TESTNET = CELO_BAKLAVA_TESTNET;
exports.CELO_MAINNET = CELO_MAINNET;
exports.CHAINS = CHAINS;
exports.COSTON_TESTNET = COSTON_TESTNET;
exports.CRONOS_MAINNET = CRONOS_MAINNET;
exports.CRONOS_TESTNET = CRONOS_TESTNET;
exports.Currency = Currency;
exports.CurrencyAmount = CurrencyAmount;
exports.ETHEREUM_MAINNET = ETHEREUM_MAINNET;
exports.EVMOS_MAINNET = EVMOS_MAINNET;
exports.EVMOS_TESTNET = EVMOS_TESTNET;
exports.EWC_MAINNET = EWC_MAINNET;
exports.EWC_TESTNET = EWC_TESTNET;
exports.FACTORY_ADDRESS = FACTORY_ADDRESS;
exports.FANTOM_MAINNET = FANTOM_MAINNET;
exports.FANTOM_TESTNET = FANTOM_TESTNET;
exports.FUSE_MAINNET = FUSE_MAINNET;
exports.FUSE_TESTNET = FUSE_TESTNET;
exports.Fetcher = Fetcher;
exports.Fraction = Fraction;
exports.HARMONY_MAINNET = HARMONY_MAINNET;
exports.HARMONY_TESTNET = HARMONY_TESTNET;
exports.HECO_MAINNET = HECO_MAINNET;
exports.HECO_TESTNET = HECO_TESTNET;
exports.INIT_CODE_HASH = INIT_CODE_HASH;
exports.IOTEX_MAINNET = IOTEX_MAINNET;
exports.IOTEX_TESTNET = IOTEX_TESTNET;
exports.InsufficientInputAmountError = InsufficientInputAmountError;
exports.InsufficientReservesError = InsufficientReservesError;
exports.KLAYTN_BAOBAB = KLAYTN_BAOBAB;
exports.KLAYTN_MAINNET = KLAYTN_MAINNET;
exports.METIS_MAINNET = METIS_MAINNET;
exports.METIS_RINKEBY = METIS_RINKEBY;
exports.MINIMUM_LIQUIDITY = MINIMUM_LIQUIDITY;
exports.MOONBEAM_MAINNET = MOONBEAM_MAINNET;
exports.MOONBEAM_MOONBASE = MOONBEAM_MOONBASE;
exports.MOONRIVER_MAINNET = MOONRIVER_MAINNET;
exports.OASIS_MAINNET = OASIS_MAINNET;
exports.OASIS_TESTNET = OASIS_TESTNET;
exports.OEC_MAINNET = OEC_MAINNET;
exports.OEC_TESTNET = OEC_TESTNET;
exports.OP_KOVAN = OP_KOVAN;
exports.OP_MAINNET = OP_MAINNET;
exports.POLYGON_MAINNET = POLYGON_MAINNET;
exports.POLYGON_MUMBAI = POLYGON_MUMBAI;
exports.Pair = Pair;
exports.Percent = Percent;
exports.Price = Price;
exports.Route = Route;
exports.Router = Router;
exports.SHIBUYA_TESTNET = SHIBUYA_TESTNET;
exports.SHIDEN_TESTNET = SHIDEN_TESTNET;
exports.SONGBIRD_MAINNET = SONGBIRD_MAINNET;
exports.TELOS_MAINNET = TELOS_MAINNET;
exports.TELOS_TESTNET = TELOS_TESTNET;
exports.Token = Token;
exports.TokenAmount = TokenAmount;
exports.Trade = Trade;
exports.WAGMI_FUJI_SUBNET = WAGMI_FUJI_SUBNET;
exports.WAVAX = WAVAX;
exports.XDAI_MAINNET = XDAI_MAINNET;
