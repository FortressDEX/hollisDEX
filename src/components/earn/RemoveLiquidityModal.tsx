...
import { CAVAX, ChainId, currencyEquals, Percent, WAVAX } from '@hollis/sdk'
...
import { ClickableText, MaxButton } from '../../pages/Pool/styleds'
  ...
  return (
    <Modal isOpen={isOpen} onDismiss={wrappedOnDismiss} maxHeight={250}>
      <ContentWrapper gap="lg">
        <RowBetween>
          <TYPE.mediumHeader>{t('navigationTabs.removeLiquidity')}</TYPE.mediumHeader>
