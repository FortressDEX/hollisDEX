import { ChainId, WAVAX } from '@hollis/sdk'
...
export const DOUBLE_SIDE_STAKING: { [key: string]: DoubleSideStaking } = {
  ...
  WAVAX_WETHe_V1: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.WETHe[ChainId.POLYGON]],
  ...
  WAVAX_USDTe_V1: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.USDTe[ChainId.POLYGON]],
  ...
  WAVAX_WBTCe_V1: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.WBTCe[ChainId.POLYGON]],
  ...
  WAVAX_LINKe_V1: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.LINKe[ChainId.POLYGON]],
  ...
  WAVAX_DAIe_V1: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.DAIe[ChainId.POLYGON]],
  ...
  WAVAX_UNIe_V1: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.UNIe[ChainId.POLYGON]],
  ...
  WAVAX_SUSHIe_V1: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.SUSHIe[ChainId.POLYGON]],
  ...
  WAVAX_AAVEe_V1: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.AAVEe[ChainId.POLYGON]],
  ...
  PNG_WETHe_V1: {
    tokens: [TOKENS.PNG[ChainId.POLYGON], TOKENS.WETHe[ChainId.POLYGON]],
  ...
  PNG_USDTe_V1: {
    tokens: [TOKENS.PNG[ChainId.POLYGON], TOKENS.USDTe[ChainId.POLYGON]],
  ...
  PNG_WBTCe_V1: {
    tokens: [TOKENS.PNG[ChainId.POLYGON], TOKENS.WBTCe[ChainId.POLYGON]],
  ...
  PNG_LINKe_V1: {
    tokens: [TOKENS.PNG[ChainId.POLYGON], TOKENS.LINKe[ChainId.POLYGON]],
  ...
  PNG_DAIe_V1: {
    tokens: [TOKENS.PNG[ChainId.POLYGON], TOKENS.DAIe[ChainId.POLYGON]],
  ...
  PNG_UNIe_V1: {
    tokens: [TOKENS.PNG[ChainId.POLYGON], TOKENS.UNIe[ChainId.POLYGON]],
  ...
  PNG_SUSHIe_V1: {
    tokens: [TOKENS.PNG[ChainId.POLYGON], TOKENS.SUSHIe[ChainId.POLYGON]],
  ...
  PNG_AAVEe_V1: {
    tokens: [TOKENS.PNG[ChainId.POLYGON], TOKENS.AAVEe[ChainId.POLYGON]],
  ...
  PNG_YFIe_V1: {
    tokens: [TOKENS.PNG[ChainId.POLYGON], TOKENS.YFIe[ChainId.POLYGON]],
    stakingRewardAddress: '0x269Ed6B2040f965D9600D0859F36951cB9F01460',
    version: 1,
    multiplier: 3
  },
  PNG_SNOB_V1: {
    tokens: [TOKENS.PNG[ChainId.POLYGON], TOKENS.SNOB[ChainId.POLYGON]],
    stakingRewardAddress: '0x08B9A023e34Bad6Db868B699fa642Bf5f12Ebe76',
    version: 1,
    multiplier: 5
  },
  PNG_VSO_V1: {
    tokens: [TOKENS.PNG[ChainId.POLYGON], TOKENS.VSO[ChainId.POLYGON]],
    stakingRewardAddress: '0x759ee0072901f409e4959E00b00a16FD729397eC',
    version: 1,
    multiplier: 5
  },
  PNG_SPORE_V1: {
    tokens: [TOKENS.PNG[ChainId.POLYGON], TOKENS.SPORE[ChainId.POLYGON]],
    stakingRewardAddress: '0x12A33F6B0dd0D35279D402aB61587fE7eB23f7b0',
    version: 1,
    multiplier: 5
  },
  PNG_BIFI_V1: {
    tokens: [TOKENS.PNG[ChainId.POLYGON], TOKENS.BIFI[ChainId.POLYGON]],
    stakingRewardAddress: '0x518B07E2d9e08A8c2e3cB7704336520827a4d399',
    version: 1,
    multiplier: 0
  },
  PNG_BNB_V1: {
    tokens: [TOKENS.PNG[ChainId.POLYGON], TOKENS.BNB[ChainId.POLYGON]],
    stakingRewardAddress: '0x68a90C38bF4f90AC2a870d6FcA5b0A5A218763AD',
    version: 1,
    multiplier: 5
  },
  PNG_XAVA_V1: {
    tokens: [TOKENS.PNG[ChainId.POLYGON], TOKENS.XAVA[ChainId.POLYGON]],
    stakingRewardAddress: '0x5b3Ed7f47D1d4FA22b559D043a09d78bc55A94E9',
    version: 1,
    multiplier: 5
  },
  PNG_PEFI_V1: {
    tokens: [TOKENS.PNG[ChainId.POLYGON], TOKENS.PEFI[ChainId.POLYGON]],
    stakingRewardAddress: '0x76e404Ab7357fD97d4f1e8Dd52f298A035fd408c',
    version: 1,
    multiplier: 5
  },
  PNG_TRYB_V1: {
    tokens: [TOKENS.PNG[ChainId.POLYGON], TOKENS.TRYB[ChainId.POLYGON]],
    stakingRewardAddress: '0x0A9773AEbc1429d860A492d70c8EA335fAa9F19f',
    version: 1,
    multiplier: 5
  },
  PNG_SHERPA_V1: {
    tokens: [TOKENS.PNG[ChainId.POLYGON], TOKENS.SHERPA[ChainId.POLYGON]],
    stakingRewardAddress: '0x80E919784e7c5AD3Dd59cAfCDC0e9C079B65f262',
    version: 1,
    multiplier: 0
  },
  PNG_YAK_V1: {
    tokens: [TOKENS.PNG[ChainId.POLYGON], TOKENS.YAK[ChainId.POLYGON]],
    stakingRewardAddress: '0x42ff9473a5AEa00dE39355e0288c7A151EB00B6e',
    version: 1,
    multiplier: 5
  },
  PNG_DYP_V1: {
    tokens: [TOKENS.PNG[ChainId.POLYGON], TOKENS.DYP[ChainId.POLYGON]],
    stakingRewardAddress: '0x3A0eF6a586D9C15de30eDF5d34ae00E26b0125cE',
    version: 1,
    multiplier: 5
  },
  PNG_QI_V1: {
    tokens: [TOKENS.PNG[ChainId.POLYGON], TOKENS.QI[ChainId.POLYGON]],
    stakingRewardAddress: '0x2bD42C357a3e13F18849C67e8dC108Cc8462ae33',
    version: 1,
    multiplier: 5
  },
  PNG_WALBT_V1: {
    tokens: [TOKENS.PNG[ChainId.POLYGON], TOKENS.WALBT[ChainId.POLYGON]],
    stakingRewardAddress: '0x393fe4bc29AfbB3786D99f043933c49097449fA1',
    version: 1,
    multiplier: 5
  },
  PNG_HUSKY_V1: {
    tokens: [TOKENS.PNG[ChainId.POLYGON], TOKENS.HUSKY[ChainId.POLYGON]],
    stakingRewardAddress: '0x07b34dAABcb75C9cbD0c8AEfbC0ed5E30845eF12',
    version: 1,
    multiplier: 5
  },
  PNG_USDCe_V1: {
    tokens: [TOKENS.PNG[ChainId.POLYGON], TOKENS.USDCe[ChainId.POLYGON]],
    stakingRewardAddress: '0x73d1cC4B8dA555005E949B3ECEE490A7206C14DF',
    version: 1,
    multiplier: 10
  },
  PNG_LYD_V1: {
    tokens: [TOKENS.PNG[ChainId.POLYGON], TOKENS.LYD[ChainId.POLYGON]],
    stakingRewardAddress: '0xe1314E6d436877850BB955Ac074226FCB0B8a86d',
    version: 1,
    multiplier: 5
  },
  PNG_TUSD_V1: {
    tokens: [TOKENS.PNG[ChainId.POLYGON], TOKENS.TUSD[ChainId.POLYGON]],
    stakingRewardAddress: '0x6fa49bd916e392dc9264636b0b5Cf2beee652dA3',
    version: 1,
    multiplier: 5
  },
  PNG_GAJ_V1: {
    tokens: [TOKENS.PNG[ChainId.POLYGON], TOKENS.GAJ[ChainId.POLYGON]],
    stakingRewardAddress: '0x95bD8FDb58692d343C89bC7bc435773779CC0e47',
    version: 1,
    multiplier: 5
  },
  PNG_GDL_V1: {
    tokens: [TOKENS.PNG[ChainId.POLYGON], TOKENS.GDL[ChainId.POLYGON]],
    stakingRewardAddress: '0xb008e7AD32c710B07fb8D4453aBC79214Cd34891',
    version: 1,
    multiplier: 0
  },
  PNG_MFI_V1: {
    tokens: [TOKENS.PNG[ChainId.POLYGON], TOKENS.MFI[ChainId.POLYGON]],
    stakingRewardAddress: '0x4c0650668A63EF468c7bDCd910A62287e9FC4d52',
    version: 1,
    multiplier: 5
  },
  PNG_SHIBX_V1: {
    tokens: [TOKENS.PNG[ChainId.POLYGON], TOKENS.SHIBX[ChainId.POLYGON]],
    stakingRewardAddress: '0xEcF9b9aE88150F11cbf2263c69823e2ECb84F07B',
    version: 1,
    multiplier: 0
  },
  PNG_AVE_V1: {
    tokens: [TOKENS.PNG[ChainId.POLYGON], TOKENS.AVE[ChainId.POLYGON]],
    stakingRewardAddress: '0x7C960e55C8119457528490C3a34C1438FaF6B039',
    version: 1,
    multiplier: 5
  },
  PNG_ELE_V1: {
    tokens: [TOKENS.PNG[ChainId.POLYGON], TOKENS.ELE[ChainId.POLYGON]],
  ...
  WAVAX_PNG_V2: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.PNG[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  PNG_USDCe_V2: {
    tokens: [TOKENS.PNG[ChainId.POLYGON], TOKENS.USDCe[ChainId.POLYGON]],
  ...
  USDTe_USDCe_V2: {
    tokens: [TOKENS.USDTe[ChainId.POLYGON], TOKENS.USDCe[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  WAVAX_SPELL_V2: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.SPELL[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  WAVAX_TIME_V2: {
  ...
  USDCe_DAIe_V2: {
    tokens: [TOKENS.USDCe[ChainId.POLYGON], TOKENS.DAIe[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  WAVAX_KLO_V2: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.KLO[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  WAVAX_WALBT_V2: {
  ...
  MIM_USDCe_V2: {
    tokens: [TOKENS.MIM[ChainId.POLYGON], TOKENS.USDCe[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  WAVAX_gOHM_V2: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.gOHM[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  WAVAX_CRA_V2: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.CRA[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  WAVAX_CRAFT_V2: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.CRAFT[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  WAVAX_MAXI_V2: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.MAXI[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  TUSD_DAIe_V2: {
    tokens: [TOKENS.TUSD[ChainId.POLYGON], TOKENS.DAIe[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  WAVAX_AVAI_V2: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.AVAI[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  WAVAX_ORCA_V2: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.ORCA[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  WAVAX_JEWEL_V2: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.JEWEL[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  NFTD_USDTe_V2: {
    tokens: [TOKENS.NFTD[ChainId.POLYGON], TOKENS.USDTe[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  WAVAX_CLY_V2: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.CLY[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  WAVAX_COOK_V2: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.COOK[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  USDTe_SKILL_V2: {
    tokens: [TOKENS.USDTe[ChainId.POLYGON], TOKENS.SKILL[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  MIM_WAVAX_V2: {
    tokens: [TOKENS.MIM[ChainId.POLYGON], WAVAX[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  WAVAX_TUS_V2: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.TUS[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  USDCe_USDC_V2: {
    tokens: [TOKENS.USDCe[ChainId.POLYGON], TOKENS.USDC[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  WAVAX_USDC_V2: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.USDC[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  WAVAX_HSHARES_V2: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.HSHARES[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  WAVAX_HERMES_V2: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.HERMES[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  WAVAX_PTP_V2: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.PTP[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  WAVAX_ISA_V2: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.ISA[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  WAVAX_ICE_V2: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.ICE[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  WAVAX_AVE_V2: {
  ...
  WAVAX_IDYP_V2: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.iDYP[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  WAVAX_BOOFI_V2: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.BOOFI[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  WAVAX_VSO_V2: {
  ...
  LOOT_WAVAX_V2: {
    tokens: [TOKENS.LOOT[ChainId.POLYGON], WAVAX[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  FEED_WAVAX_V2: {
    tokens: [TOKENS.FEED[ChainId.POLYGON], WAVAX[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  DCAU_WAVAX_V2: {
    tokens: [TOKENS.DCAU[ChainId.POLYGON], WAVAX[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  AGEUR_WAVAX_V2: {
    tokens: [TOKENS.agEUR[ChainId.POLYGON], WAVAX[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  MAGE_WAVAX_V2: {
    tokens: [TOKENS.MAGE[ChainId.POLYGON], WAVAX[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  HTZ_WAVAX_V2: {
    tokens: [TOKENS.HTZ[ChainId.POLYGON], WAVAX[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  PLN_WAVAX_V2: {
    tokens: [TOKENS.PLN[ChainId.POLYGON], WAVAX[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  HEC_WAVAX_V2: {
    tokens: [TOKENS.HEC[ChainId.POLYGON], WAVAX[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  WAVAX_RACEX_V2: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.RACEX[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },

  WAVAX_axlUST_V2: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.axlUST[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  USDC_axlUST_V2: {
    tokens: [TOKENS.USDC[ChainId.POLYGON], TOKENS.axlUST[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  WAVAX_LUNA_V2: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.LUNA[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  WAVAX_AAVEe_V2: {
  ...
  WAVAX_IME_V2: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.IME[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  WAVAX_AVXT_V2: {
  ...
  WAVAX_MONEY_V2: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.MONEY[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  WAVAX_YDR_V2: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.YDR[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  WAVAX_FIRE_V2: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.FIRE[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  WAVAX_BAVA_V2: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.BAVA[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  WAVAX_BRIBE_V2: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.BRIBE[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  WAVAX_AGF_V2: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.AGF[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  WAVAX_ODDZ_V2: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.ODDZ[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  axlUST_DLAUNCH_V2: {
    tokens: [TOKENS.axlUST[ChainId.POLYGON], TOKENS.DLAUNCH[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  WAVAX_ACRE_V2: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.ACRE[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  WAVAX_sAVAX_V2: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.sAVAX[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  WAVAX_DEP_V2: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.DEP[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  WAVAX_ZEE_V2: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.ZEE[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  WAVAX_TOMB_V2: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.TOMB[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  WAVAX_MAI_V2: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.MAI[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  WAVAX_BUSINESSES_V2: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.BUSINESSES[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  WAVAX_DOLLA_V2: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.DOLLA[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  WAVAX_NCASH_V2: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.NCASH[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  WAVAX_KACY_V2: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.KACY[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  WAVAX_OML_V2: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.OML[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },

  USDC_JPYC_V2: {
    tokens: [TOKENS.USDC[ChainId.POLYGON], TOKENS.JPYC[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  UST_PNG_V2: {
    tokens: [TOKENS.UST[ChainId.POLYGON], TOKENS.PNG[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  WAVAX_UST_V2: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.UST[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  UST_USDC_V2: {
    tokens: [TOKENS.UST[ChainId.POLYGON], TOKENS.USDC[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  WAVAX_axlATOM_V2: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.axlATOM[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  },
  WAVAX_LOST_V2: {
    tokens: [WAVAX[ChainId.POLYGON], TOKENS.LOST[ChainId.POLYGON]],
    stakingRewardAddress: MINICHEF_ADDRESS[ChainId.POLYGON],
    version: 2
  }
}
...
export const DOUBLE_SIDE_STAKING_REWARDS_INFO: {
  ...
  [ChainId.FUJI]: [],
  [ChainId.POLYGON]: [DOUBLE_SIDE_STAKING_V0, DOUBLE_SIDE_STAKING_V1, DOUBLE_SIDE_STAKING_V2],
