import { ChainId, Token } from '@hollis/sdk'
...
export const PNG: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.POLYGON]: new Token(
    ChainId.POLYGON,
    '0xe31c4a128b340267C893f31a0f5987c2F1A742B4',
    18,
    'HOL',
    'Hollis'
  ),
...
export const OG: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.POLYGON]: new Token(ChainId.POLYGON, ZERO_ADDRESS, 18, 'OG', 'OG'),
...
export const CNDL: { [chainId in ChainId]: Token } = {
  [ChainId.FUJI]: new Token(ChainId.FUJI, ZERO_ADDRESS, 18, 'CNDL', 'Candle'),
  [ChainId.POLYGON]: new Token(ChainId.POLYGON, '0x5423063af146F5abF88Eb490486E6B53FA135eC9', 18, 'CNDL', 'Candle'),
  [ChainId.WAGMI]: new Token(ChainId.WAGMI, ZERO_ADDRESS, 18, 'CNDL', 'Candle')
}
...
export const WETHe: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.POLYGON]: new Token(
    ChainId.POLYGON,
    '0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619', // changed to Polygon
    18,
    'WETH.e',
    'Ether'
  ),
...
export const BNB: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.POLYGON]: new Token(ChainId.POLYGON, '0x264c1383EA520f73dd837F915ef3a732e204a493', 18, 'BNB', 'Binance'),
...
export const TRYB: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.POLYGON]: new Token(ChainId.POLYGON, '0x564A341Df6C126f90cf3ECB92120FD7190ACb401', 6, 'TRYB', 'BiLira'),
  [ChainId.WAGMI]: new Token(ChainId.POLYGON, ZERO_ADDRESS, 6, 'TRYB', 'BiLira')
}
...
export const HUSKY: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.POLYGON]: new Token(ChainId.POLYGON, '0x65378b697853568dA9ff8EaB60C13E1Ee9f4a654', 18, 'HUSKY', 'Husky'),
...
export const GDL: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.POLYGON]: new Token(ChainId.POLYGON, '0xD606199557c8Ab6F4Cc70bD03FaCc96ca576f142', 18, 'GDL', 'Gondola'),
...
export const AVE: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.POLYGON]: new Token(ChainId.POLYGON, '0x78ea17559B3D2CF85a7F9C2C704eda119Db5E6dE', 18, 'AVE', 'Avaware'),
...
export const FRAX: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.POLYGON]: new Token(ChainId.POLYGON, '0xDC42728B0eA910349ed3c6e1c9Dc06b5FB591f98', 18, 'FRAX', 'Frax'),
...
export const XDO: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.POLYGON]: new Token(ChainId.POLYGON, '0x9eF758aC000a354479e538B8b2f01b917b8e89e7', 18, 'XDO', 'xDollar'),
...
export const VEE: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.POLYGON]: new Token(ChainId.POLYGON, '0x3709E8615E02C15B096f8a9B460ccb8cA8194e86', 18, 'VEE', 'Vee'),
...
export const AVXT: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.WAGMI]: new Token(ChainId.POLYGON, ZERO_ADDRESS, 6, 'AVXT', 'Avaxtars')
}
...
export const CNR: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.POLYGON]: new Token(ChainId.POLYGON, '0x8D88e48465F30Acfb8daC0b3E35c9D6D7d36abaf', 18, 'CNR', 'Canary'),
...
export const CYCLE: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.POLYGON]: new Token(ChainId.POLYGON, '0x81440C939f2C1E34fc7048E518a637205A632a74', 18, 'CYCLE', 'Cycle'),
...
export const WOW: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.POLYGON]: new Token(ChainId.POLYGON, '0xA384Bc7Cdc0A93e686da9E7B8C0807cD040F4E0b', 18, 'WOW', 'WOWswap'),
...
export const TEDDY: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.POLYGON]: new Token(ChainId.POLYGON, '0x094bd7B2D99711A1486FB94d4395801C6d0fdDcC', 18, 'TEDDY', 'TEDDY'),
...
export const AVME: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.POLYGON]: new Token(ChainId.POLYGON, '0x1ECd47FF4d9598f89721A2866BFEb99505a413Ed', 18, 'AVME', 'AVME'),
...
export const TIME: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.POLYGON]: new Token(ChainId.POLYGON, '0xb54f16fB19478766A268F172C9480f8da1a7c9C3', 9, 'TIME', 'Time'),
...
export const FRAXV2: { [chainId in ChainId]: Token } = {
  [ChainId.FUJI]: new Token(ChainId.FUJI, ZERO_ADDRESS, 18, 'FRAX', 'Frax'),
  [ChainId.POLYGON]: new Token(ChainId.POLYGON, '0xD24C2Ad096400B6FBcd2ad8B24E7acBc21A1da64', 18, 'FRAX', 'Frax'),
  [ChainId.WAGMI]: new Token(ChainId.WAGMI, ZERO_ADDRESS, 18, 'FRAX', 'Frax')
}

export const ROCO: { [chainId in ChainId]: Token } = {
  [ChainId.FUJI]: new Token(ChainId.FUJI, ZERO_ADDRESS, 18, 'ROCO', 'ROCO'),
  [ChainId.POLYGON]: new Token(ChainId.POLYGON, '0xb2a85C5ECea99187A977aC34303b80AcbDdFa208', 18, 'ROCO', 'ROCO'),
...
export const IMX: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.POLYGON]: new Token(ChainId.POLYGON, '0xeA6887e4a9CdA1B77E70129E5Fba830CdB5cdDef', 18, 'IMX', 'IMX'),
...
export const ORBS: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.POLYGON]: new Token(ChainId.POLYGON, '0x340fE1D898ECCAad394e2ba0fC1F93d27c7b717A', 18, 'ORBS', 'Orbs'),
...
export const CRA: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.POLYGON]: new Token(ChainId.POLYGON, '0xA32608e873F9DdEF944B24798db69d80Bbb4d1ed', 18, 'CRA', 'Crabada'),
...
export const CRAFT: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.POLYGON]: new Token(ChainId.POLYGON, '0x8aE8be25C23833e0A01Aa200403e826F611f9CD2', 18, 'CRAFT', 'CRAFT'),
...
export const AVAI: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.POLYGON]: new Token(ChainId.POLYGON, '0x346A59146b9b4a77100D369a3d18E8007A9F46a6', 18, 'AVAI', 'AVAI'),
...
export const agEUR: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.POLYGON]: new Token(ChainId.POLYGON, '0x6fefd97f328342a8a840546a55fdcfee7542f9a8', 18, 'agEUR', 'agEUR'),
...
export const PLN: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.POLYGON]: new Token(ChainId.POLYGON, '0x7b2b702706d9b361dfe3f00bd138c0cfda7fb2cf', 18, 'PLN', 'Pollen'),
...
export const YDR: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.POLYGON]: new Token(ChainId.POLYGON, '0xf03Dccaec9A28200A6708c686cf0b8BF26dDc356', 18, 'YDR', 'YDragon'),
...
export const RACEX: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.POLYGON]: new Token(ChainId.POLYGON, '0x7086e045b78e1e72f741f25231c08d238812cf8a', 18, 'RACEX', 'RaceX'),
...
export const FIRE: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.POLYGON]: new Token(ChainId.POLYGON, '0xfcc6CE74f4cd7eDEF0C5429bB99d38A3608043a5', 18, 'FIRE', 'FIRE'),
...
export const BRIBE: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.POLYGON]: new Token(ChainId.POLYGON, '0xCe2fbed816E320258161CeD52c2d0CEBcdFd8136', 18, 'BRIBE', 'BRIBE'),
...
export const TOMB: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.POLYGON]: new Token(ChainId.POLYGON, '0xb84527D59b6Ecb96F433029ECc890D4492C5dCe1', 18, 'TOMB', 'TOMB'),
...
export const OML: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.POLYGON]: new Token(ChainId.POLYGON, '0x979fFD8eEd7a43629eA29581DF4Bfe2b3F224e47', 18, 'OML', 'Omlira'),
